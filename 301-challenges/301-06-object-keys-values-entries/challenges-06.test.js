...
const hasChildrenValues = (arr, character) => {
  // Solution code here...
  for (let obj in arr){
  //   if (arr[obj].name === character && arr[obj].children !== []){
  //     return true;
  //   }
  // }
  // return false;
    if (Object.values(arr[obj])[0] === character && Object.values(arr[obj])[2] !== []){
      return true;
    }
  }
  return false;
...
const hasChildrenEntries = (arr, character) => {
  // Solution code here...
  for (let obj in arr){
    if (Object.entries(arr[obj])[0][1] === character && Object.entries(arr[obj])[2][1].length !== 0){
      return true;
    }
  }
  return false;
...
const totalCharacters = (arr) => {
  // Solution code here...
  let charNum = arr.length;
  for (let obj in arr){
    let spouse=0;
    if (arr[obj].spouse !== null){
      spouse =1;
    }
    charNum += arr[obj].children.length + spouse;
  }
  return charNum;
};
...
const houseSize = (arr) => {
  ...
  for (let obj in arr){
    let newObj = {};
    let member = 0;
    newObj.house = arr[obj].house;
    if (arr[obj].spouse !== null){
      member = 2 + arr[obj].children.length;
    } else {
      member = 1 + arr[obj].children.length;
    }
...
const houseSurvivors = (arr) => {
  ...
  for (let obj in arr){
    ...
    let member = 0;
    newObj.house = arr[obj].house;  
    if (arr[obj].spouse !== null && deceasedSpouses.indexOf(arr[obj].spouse) === -1 ){
      member = 2 + arr[obj].children.length;
    } else if (arr[obj].spouse === null || deceasedSpouses.indexOf(arr[obj].spouse) !== -1) {
      member = 1 + arr[obj].children.length;
    }
    newObj.members = member;
